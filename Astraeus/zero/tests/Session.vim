...
set path=.,/usr/include,,,~/code/Astraeus/zero,~/code/Astraeus/zero/src,~/code/Astraeus/zero/tests
set printoptions=paper:letter
set ruler
set runtimepath=~/.vim,~/.vim/bundle/NERDTree,~/.vim/bundle/indexer,~/.vim/bundle/omnicomplete,~/.vim/bundle/project,~/.vim/bundle/snipmate,~/.vim/bundle/tagbar,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim73,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/bundle/omnicomplete/after,~/.vim/bundle/snipmate/after,~/.vim/after
set shiftwidth=3
set suffixes=.bak,~,.swp,.o,.info,.aux,.log,.dvi,.bbl,.blg,.brf,.cb,.ind,.idx,.ilg,.inx,.out,.toc
set tags=./tags,./TAGS,tags,TAGS,~/.vim/tags/cpp,~/.vim/tags/gl,~/.vimtags/zero
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd ~/code/Astraeus/zero/tests
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ship_unittest.cpp
badd +0 ~/code/Astraeus/zero/src/ship.cpp
badd +0 ~/code/Astraeus/zero/src/ship.h
silent! argdel *
edit ship_unittest.cpp
...
exe 'vert 4resize ' . ((&columns * 62 + 79) / 158)
argglobal
enew
file NERD_tree_1
setlocal keymap=
...
wincmd w
argglobal
edit ~/code/Astraeus/zero/src/ship.h
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
wincmd w
argglobal
edit ~/code/Astraeus/zero/src/ship.cpp
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal nobinary
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((20 * winheight(0) + 10) / 21)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
